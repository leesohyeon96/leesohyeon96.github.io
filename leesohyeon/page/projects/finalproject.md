...
- **개발 환경**
  ...
  - **Mabatis**
  - **JPA**
  <img src="{{ site.baseurl }}/img/finalTools.png">
  <img src="{{ site.baseurl }}/img/finalTools2.png">  

***

- **맡은 역할 : 형상관리자 (깃랩, 소스트리 commit & push, merge, commitMessage 관리)**
  <img src="{{ site.baseurl }}/img/finalRole1.png">
  <img src="{{ site.baseurl }}/img/finalRole2.png">  
...
- **팀원 한마디 : '적극적이며 행동력 있는 팀원'**
  ...
  <img src="{{ site.baseurl }}/img/finalProjectTeamIntroduce.png">   -->

***

- **전반적인 설계 과정**
  <br/>
  <img src="{{ site.baseurl }}/img/finalModeling1.png">
  => **논리모델링 1.0.0ver ~ 2.0.0ver까지 설계하였습니다.**  
 <br/>
  <img src="{{ site.baseurl }}/img/finalModeling2.png">  
  => **논리모델링 2.0.0ver 입니다.**
 <br/>
  <img src="{{ site.baseurl }}/img/finalairbnbphoto.jpg">
  <img src="{{ site.baseurl }}/img/finalairbnbphoto3.jpg">
  => **밤을 새며 발표를 준비하는 모습입니다.**
 <br/>
  <img src="{{ site.baseurl }}/img/finalairbnbphoto2.jpg">
  => **논리모델링 설계 회의 장면입니다.**
...
- **구체적인 코드 설명[2가지]**
  ...
  <img src="{{ site.baseurl }}/img/finalProjectMenuModifyForProjectMenu.png">
